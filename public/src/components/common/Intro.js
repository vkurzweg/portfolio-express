  ...
  render() {
    ...
    return (
      <div className="container" style={{ width: '100%', backgroundColor: 'black', color: 'white', padding: '1%', fontSize: '16px' }}>
        ...
        <h3 style={{ textAlign: 'center', color: 'white', fontFamily: 'Share', fontSize: '24px', padding: '1em', letterSpacing: '1px', width: '75%', margin: '0 auto', marginTop: '2%', lineHeight: '1.5em' }}>VK Digital is a branding, design, and development consultancy. We specialize in making on-brand websites that look great on mobile + desktop.</h3>
      </div>
    );
