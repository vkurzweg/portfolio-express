  ...
  render() {
    ...
    return (
      <div className="container" style={{ width: '100%', backgroundColor: 'black', color: 'white', padding: '1%', fontSize: '16px' }}>
        ...
        <h2 style={{ color: 'white', fontFamily: 'Share', fontSize: '26px', padding: '1em', letterSpacing: '1px', width: '86%', margin: '0 auto', marginTop: '2%', lineHeight: '1.5em', textAlign: 'center' }}>vk.digital is a branding, design, and development consultancy.</h2>
        <h2 style={{ color: 'white', fontFamily: 'Share', fontSize: '26px', padding: '1em', letterSpacing: '1px', width: '86%', margin: '0 auto', lineHeight: '1em', marginTop: '-2%', textAlign: 'center' }}>We specialize in making on-brand websites that look great on mobile + desktop.</h2>
      </div>
    );
