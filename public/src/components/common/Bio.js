      ...
      <div id="bio" className="container" style={{ width: '100%', backgroundColor: '#212121', color: '#FAFAFA', textAlign: 'center', fontSize: '16px' }}>
        <div className="row">
          ...
          <div className="col-sm-6" style={{ marginTop: '6%', marginLeft: '3%', width: '100%', paddingBottom: '5%' }}>
            <p style={{ fontSize: '14px', textAlign: 'left', marginRight: '10%', marginLeft: '10%', marginBottom: '2%' }}>Before pivoting to tech in 2016, I worked in sales, international search marketing, journalism and public affairs. <a href="/resume" target="blank" style={{ textDecoration: 'none', color: '#108EE9', fontWeight: 'bold' }}>Here's my resume.</a></p>
