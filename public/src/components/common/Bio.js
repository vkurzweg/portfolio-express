      ...
      <div id="bio" className="container" style={{ width: '100%', backgroundColor: '#212121', color: '#FAFAFA', textAlign: 'center', fontSize: '16px', marginTop: '-2%' }}>
        <div className="row" style={{ width: '80%', margin: '0 auto' }}>
          ...
          <div className="col-sm-6" style={{ marginTop: '3%', marginLeft: '3%', width: '100%', paddingBottom: '5%' }}>
            ...
            <p style={{ fontSize: '14px', textAlign: 'justify', marginRight: '10%', marginLeft: '10%', marginBottom: '3%' }}>With a background in writing (commentary, news and commercial copy), Victoria approaches her work with an editorial eye and an appreciation for good storytelling. She is deeply influenced by print and extra interested in projects that encompass multiple types of media.</p>
