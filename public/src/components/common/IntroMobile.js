    ...
    return (
      <div className="container" style={{ width: '100%', backgroundColor: 'black', color: 'white', padding: '1%', fontSize: '16px' }}>
        ...
        <div style={{ width: '90%', margin: '0 auto', fontFamily: 'Helvetica' }}>
          <h2 style={{ color: 'white', fontSize: '14px', padding: '1em', letterSpacing: '1px', width: '75%', margin: '0 auto', marginTop: '2%', lineHeight: '1.5em', textAlign: 'justify' }}>VK Digital is a branding, design, and development consultancy. We specialize in making on-brand websites that look great on mobile + desktop.</h2>
        </div>
      </div>
    );
