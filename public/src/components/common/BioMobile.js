      ...
      <div id="bio" className="container" style={{ width: '100%', backgroundColor: 'black', color: '#FAFAFA', textAlign: 'center', fontSize: '16px', marginTop: '-2%', padding: '0' }}>
        <div className="row" style={{ width: '100%', margin: '0 auto' }}>
          <div className="col-sm-6" style={{ display: 'block', margin: '0 auto' }}>
            ...
            <Image cloudName="kurzweg" publicId="headshot_edit2" quality="auto" responsive alt="Victoria Kurzweg" style={{ width: '70%', paddingTop: '5%', display: 'block', margin: '0 auto'}} />
          </div>
          <div className="col-sm-6" style={{ marginTop: '8%', marginLeft: '3%', paddingBottom: '3%' }}>
            ...
            <p style={{ fontSize: '14px', textAlign: 'justify', marginRight: '7%', marginLeft: '7%', marginBottom: '3%' }}>With a <A href="/resume" target="blank">background</A> in writing, Victoria approaches her work with an editorial eye and an appreciation for good storytelling. She was born in New Orleans and graduated with a master's degree in history of international relations from the London School of Economics. Her interests include food and drink, fashion, travel and contemporary art.</p>
