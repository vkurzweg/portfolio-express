      ...
      <div id="bio" className="container" style={{ width: '100%', backgroundColor: 'black', color: '#FAFAFA', textAlign: 'center', fontSize: '16px', marginTop: '-2%' }}>
        <div className="row" style={{ width: '100%', margin: '0 auto' }}>
          <div className="col-sm-6" style={{ display: 'block', margin: '0 auto' }}>
            <Image cloudName="kurzweg" publicId="palma" quality="auto" responsive alt="Victoria Kurzweg" style={{ maxHeight: '400px', maxWidth: '80%', paddingTop: '10%', display: 'block', margin: '0 auto'}} />
          </div>
          <div className="col-sm-6" style={{ marginTop: '3%', marginLeft: '3%', paddingBottom: '3%' }}>
            ...
            <button onClick={this.props.toggleForm} style={{ textDecoration: 'none', backgroundColor: '#108EE9', color: '#212121', width: '50%', height: '3em', margin: '0 auto', border: 'none', textTransform: 'uppercase', letterSpacing: '1px', borderRadius: '2px', fontSize: '18px', fontWeight: 'bold' }}>Let's talk</button>
          </div>
        </div>
        <div style={{ display }}>
