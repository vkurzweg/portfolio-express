...
const phrases = ['Custom web design + development', 'Optimization + engagement across devices', 'On-brand content enhancement', 'Thoughtful UIs', 'Modern technologies + design patterns' ]
const interval = 2500;
